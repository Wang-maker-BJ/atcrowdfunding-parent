            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" action="${PATH}/admin/add" method="post">
                        <div style="color: red">${adderrorMsg}</div>
                        <%
                            session.removeAttribute("adderrorMsg");
                        %>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" value="@qq.com" class="form-control" id="exampleInputEmail1" placeholder="请输入邮箱地址">
